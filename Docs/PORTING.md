...
- app-server live turn execution cancellation/completion/event streaming, review/MCP APIs, account write-refresh flows, general config writes, and protocol generators
- apply-patch runtime
