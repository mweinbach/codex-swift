...
- app-server live thread start/turn/review/MCP APIs, account write-refresh flows, general config writes, and protocol generators
- apply-patch runtime
