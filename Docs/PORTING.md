...
- `codex-rs/core/src/shell.rs`
  - shell type detection including Rust `PathBuf` platform-native separator behavior, shell name mapping, exec argument derivation, PowerShell UTF-8 output prefixing, model-provided shell fallback, default shell fallback ordering, and Rust-matching real-file checks before accepting a detected user default shell path
